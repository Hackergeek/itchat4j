...
public class WechatTools {
    ...
    public static void dumpCookie() {
        ...
        FileOutputStream fs;
        try {
            fs = new FileOutputStream(Core.getInstance().getHotReloadDir());
            final ObjectOutputStream os = new ObjectOutputStream(fs);
            os.writeObject(core.getMyHttpClient().getCookieStore());
            os.close();
    ...
    public static CookieStore readCookieStore() {
        FileInputStream fs;
        try {
            fs = new FileInputStream(Core.getInstance().getHotReloadDir());
